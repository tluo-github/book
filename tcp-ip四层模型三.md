...
我们能看到TCP创建经过了3次握手，第一次我本地192.168.11.200:12964向120.55.85.46:80发出了一个SYN(其他参数也很重要暂时忽悠，只与为什么我输入的是域名这里确是IP这个是因为DNS，以后解释)
第二个TCP包是服务器(120.55.85.46：80)向我本地(192.168.11.200:12964)发送了SYN,ACK
第三个TCP是我本地(192.168.11.200:12964)向服务器(120.55.85.46：80)发送ACK
然后完成TCP创建下一个就是HTTP开始工作
